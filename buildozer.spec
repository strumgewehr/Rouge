...
# (list) Include extra files/folders
...
requirements = python3,flask==3.0.0,flask-socketio==5.3.5,python-socketio==5.10.0,eventlet==0.33.3
...
# (int) Target Android API, should be high enough to not support outdated Android versions.
#android.api = 27
...
# (str) Filename to log the output of the p4a build process
#p4a.log_dir =

# (str) python-for-android specific requirements (e.g. requirements.txt)
#p4a.requirements = ''

# (str) python-for-android specific requirements (e.g. requirements.txt)
#p4a.android_entrypoint = 'org.rouge.rouge'

# (str) python-for-android bootstrap to use
#p4a.bootstrap = sdl2

# (str) name of the main activity to run 
#android.activity_name = org.rouge.rouge
